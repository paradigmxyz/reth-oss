...
impl TreeConfig {
    ...
    /// Returns whether sparse-trie state root computation may use storage roots carried by the BAL.
    pub const fn take_bal_storage_roots(&self) -> bool {
        self.take_bal_storage_roots
    }

    /// Setter for whether sparse-trie state root computation may use BAL-carried storage roots.
    pub const fn with_take_bal_storage_roots(mut self, take_bal_storage_roots: bool) -> Self {
        self.take_bal_storage_roots = take_bal_storage_roots;
        self
    }
