...
use crate::{NewBlockPayload, PooledTransactionResponse};
...
where
    N: NodePrimitives,
    Pooled: SignedTransaction + TryFrom<N::SignedTx> + PooledTransactionResponse + 'static,
