...
impl DefaultRpcServerArgs {
    ...
    /// Set whether `eth_simulateV1` computes state roots by default
...
pub struct RpcServerArgs {
    ...
    #[arg(long = "rpc.compute-state-root-for-eth-simulate", env = "RETH_RPC_COMPUTE_STATE_ROOT_FOR_ETH_SIMULATE", default_value_t = DefaultRpcServerArgs::get_global().rpc_compute_state_root_for_eth_simulate)]
