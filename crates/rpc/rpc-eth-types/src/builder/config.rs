...
pub struct EthConfig {
    ...
    /// Whether `eth_simulateV1` computes state roots for simulated blocks.
...
impl EthConfig {
    ...
    /// Configures whether `eth_simulateV1` computes state roots for simulated blocks.
    pub const fn compute_state_root_for_eth_simulate(mut self, compute: bool) -> Self {
        self.compute_state_root_for_eth_simulate = compute;
        self
    }
