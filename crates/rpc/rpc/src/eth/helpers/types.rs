...
mod tests {
    ...
    fn test_resolve_transaction_empty_request() {
        ...
        let result = resolve_transaction(tx, 21000, 0, 1, &mut db, &builder, false).unwrap();
    ...
    fn test_resolve_transaction_legacy() {
        ...
        let tx = resolve_transaction(tx, 21000, 0, 1, &mut db, &builder, false).unwrap();
    ...
    fn test_resolve_transaction_partial_eip1559() {
        ...
        let result = resolve_transaction(tx, 21000, 0, 1, &mut db, &rpc_converter, false).unwrap();
    ...
    fn test_resolve_simulate_blob_transaction_without_sidecar() {
        ...
        let result = resolve_transaction(tx, 21_000, 15, 1, &mut db, &rpc_converter, false)
